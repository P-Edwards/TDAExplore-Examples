...
png("computation_results/arp_many_radius_patch_accuracy.png",height=512,width=512)
print(patch_plot)
dev.off()
png("computation_results/arp_many_radius_image_accuracy.png",height=512,width=512)
print(image_plot)
dev.off()

save(accuracies_results,"computation_results/arp_many_radius.RData",version=2)
