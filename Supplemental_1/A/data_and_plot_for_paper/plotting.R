...
load("pfn1_2ratio_many_radius.RData")
...
png("pfn1_many_radius_patch_accuracy.png",height=512,width=512)
print(patch_plot)
dev.off()
png("pfn1_many_radius_image_accuracy.png",height=512,width=512)
print(image_plot)
dev.off()
